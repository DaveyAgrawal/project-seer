    ...
    try {
      ...
      const features = result.rows.map(row => ({
        ...
        properties: {
          ...
          miles_to_airport: row.miles_to_airport,
          breadcrumb_hierarchy: row.breadcrumb_hierarchy,
          market_region: row.market_region,
          nearby_datacenter_count: row.nearby_datacenter_count,
          phone_number: row.phone_number,
          has_images: row.has_images,
          has_brochures: row.has_brochures,
